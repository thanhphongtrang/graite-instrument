...
10. **Career posture: both doors open until Y3 checkpoint; hybrid bridge 2030–32; ≥1 IS/HCI-venue output per year** (2026-07-12) — Decided by Phong (structured choice during strategy session; full architecture in phd-vault/projects/four-year-strategy.md §5). (1) Swedish citizenship (~2031 application, 8-year hemvist rule) and Vietnam return are BOTH kept alive until a year-3 checkpoint (autumn 2029) — no earlier commitment; agents must not optimize plans for one door at the other's expense. (2) The intended 2030–32 bridge is hybrid: part-time academic affiliation + industry/founder work in Sweden while any citizenship case matures. (3) Primary Vietnam arena: international university (RMIT/VinUni/Fulbright) — optimize portfolio for publications + teaching + shipped tools. (4) Standing rule agents CAN act on: maintain ≥1 IS/HCI-venue output per year (ECIS/CHI/CSCW or equivalent) alongside education venues — the portability lever; flag any year where the publication plan lacks one. (5) Do-early admin: citizenship civics test (from Aug 2026) and language test (~Oct 2027) taken during years 1–2. MySwedenLife remains the sole bisyssla (~10%), the living industry portfolio.
